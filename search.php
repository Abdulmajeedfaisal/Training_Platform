...
<body>
    ...
    <section class="filters" style="padding-bottom: 0;" style="direction: rtl;">
    ...
    <section class="listings" style="direction: rtl;">
        ...
        if (isset($_POST['search_box']) or isset($_POST['search_btn'])) {
            echo '<h1 class="heading">نتائج البحث </h1>';
        } else {
            echo '<h1 class="heading">قائمة المؤسسات المتاحه </h1>';
        }
        ?>
            ...
            ?>
                    <form action="" method="POST" style="direction: rtl;">
                        <div class="box">
                            ...
                            <p class="location"><i class=" fas fa-map-marker-alt"></i><a href="<?= $fetch_company['address']; ?>" target="_blank"><span><?= $fetch_company['address']; ?></span></a>
