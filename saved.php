...
<body>
    ...
    <section class="listings" style="direction: rtl;">
        ...
        <h1 class="heading">الدورات المحفوظة </h1>

        <div class="box-container">
            <?php
            $total_images = 0;
            $select_saved_property = $conn->prepare("SELECT * FROM `saved` WHERE user_id = :saved_id");
            $select_saved_property->bindParam(':saved_id', $user_id);
            ...
            <form action="" method="POST">
                <div class="box">
                    ...
                    <button type="submit" name="save" class="save" style="direction: ltr;"><i
                            class="fas fa-heart"></i><span>remove from
                            saved</span></button>
                    <?php
                                    } else {
                                    ?>
            ...
            <?php
                ...
                echo '<p class="empty">لم يتم حفظ دورة بعد! <a href="listings.php" style="margin-top:1.5rem;" class="btn">إبحث</a></p>';
            }
            ?>
